CarrierWave.configure do |config|
  ...
  config.aliyun_access_id = "LTAIsvnGsd9GGs1J"
  config.aliyun_access_key = '2UuuxL6NSbjZ9jMufHJObSvmtp0VYK'
  # 你需要在 Aliyum OSS 上面提前创建一个 Bucket
  config.aliyun_bucket = "hpd-ieltsbro"
  ...
  config.aliyun_host = "https://hpd-ieltsbro.oss-cn-shenzhen.aliyuncs.com"
